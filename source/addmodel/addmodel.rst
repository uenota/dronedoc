...
plugin
    センサの動作をシミュレートするためのものです。今回はレーザのプラグインを使っています。詳細は `ここ <http://gazebosim.org/tutorials?tut=ros_gzplugins#GPULaser>`_ を見てください。
...
.. code-block:: bash
    ...
    roslaunch px4 posix_sitl.launch sdf:=~/catkin_ws/src/px4_sim_pkg/models/iris_2d_lidar/model.sdf

mavros_posix_sitl.launchを使う場合には以下のようにします。

.. code-block:: bash

    roslaunch px4 mavros_posix_sitl.launch sdf:=~/catkin_ws/src/px4_sim_pkg/models/iris_2d_lidar/model.sdf
